...
if(typeof bandinfo == 'undefined')
{
  ...
  bandinfo_request.open('GET', '/tmp/bandinfo.js');
...
var nwaterfalls=0;
var waterslowness=4;
//var waterslowness=30; // Changed 28/3 for assisting GES
var waterheight=100;
//setTimeout(function() { waterfallheight(600); setmute(true); }, 600); // Changed 28/3 for assisting GES
var watermode=1;
var scaleheight=14;
...
function set_mode(m)      // ...with appropriate filter
{
   switch (m.toUpperCase()) {
      case "USB":
        setmf("usb", 0.3+(0.091/2),  2.7-(0.091/2));
	...
	break;
      case "LSB":
        setmf("lsb", -2.7+(0.091/2), -0.3-(0.091/2));
        document.getElementById("btn-CW").classList.remove('btn-selected');
...
function keydown(e)
{
   ...
   switch (e.keyCode) {
      ...
      case 70: setmf ('fm',  -7  ,  7  );    return cancelEvent(e);    // F
